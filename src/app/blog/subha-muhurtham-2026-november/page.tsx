...
export const metadata: Metadata = {
    ...
    description: '2026 நவம்பர் மாதத்திற்கான சிறந்த சுப முகூர்த்த நாட்கள். November 2026 திருமண தேதிகள் மற்றும் நல்ல நேரங்களை இங்கே சரிபார்க்கவும்.',
    alternates: {
    ...
    return (
        <article className="container mx-auto px-4 py-12 max-w-4xl">
            ...
            <Schema 
                ...
                data={{
                    items: [
                        ...
                        { name: 'சுப முகூர்த்த நாட்கள் நவம்பர் 2026', item: '/blog/subha-muhurtham-2026-november' }
                    ]
                }}
            />
            <header className="mb-10 text-center">
                <h1 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                    2026 நவம்பர் சுப முகூர்த்த நாட்கள்
                </h1>
                <div className="relative h-[300px] md:h-[450px] w-full mb-10 rounded-3xl overflow-hidden shadow-2xl">
                    <OptimizedImage
                        ...
                        alt="2026 நவம்பர் முகூர்த்த நாட்கள்"
                        fill
            ...
            <div className="prose prose-lg max-w-none text-gray-800 space-y-8 leading-relaxed">
                <p className="text-xl">
                    2026 ஆம் ஆண்டு நவம்பர் மாதத்தில் திருமணம் செய்யத் திட்டமிட்டுள்ளீர்களா? 
            ...
            <div className="my-12 p-8 bg-orange-50/50 border border-orange-100 rounded-3xl text-gray-800 space-y-4">
                <h3 className="text-xl font-bold text-gray-900">November 2026 முகூர்த்த நாட்களின் சிறப்புகள்:</h3>
                <p className="leading-relaxed">கார்த்திகை மாதம் தீப திருவிழாக்களின் மாதமாகும். இந்த மாதத்தில் திருமணங்கள் செய்வது தம்பதியினரின் வாழ்வில் ஞானத்தையும், ஒளியையும் ஏற்றும் என்பது நம்பிக்கை. கார்த்திகை சோமவாரம் மற்றும் வளர்பிறை தேதிகள் திருமணத்திற்கு மிகவும் உகந்தவை. இந்த மாதத்தில் வரும் முகூர்த்த தேதிகளில் திருமணம் செய்வதன் மூலம் கணவன் மனைவி இடையே அன்பும், பரஸ்பர மரியாதையும் எப்போதும் நிலைத்திருக்கும்.</p>
