...
export const metadata: Metadata = {
    ...
    description: '2026 மார்ச் மாதத்திற்கான சிறந்த சுப முகூர்த்த நாட்கள். March 2026 திருமண தேதிகள் மற்றும் நல்ல நேரங்களை இங்கே சரிபார்க்கவும்.',
    alternates: {
    ...
    return (
        <article className="container mx-auto px-4 py-12 max-w-4xl">
            ...
            <Schema 
                ...
                data={{
                    items: [
                        ...
                        { name: 'சுப முகூர்த்த நாட்கள் மார்ச் 2026', item: '/blog/subha-muhurtham-2026-march' }
                    ]
                }}
            />
            <header className="mb-10 text-center">
                <h1 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                    2026 மார்ச் சுப முகூர்த்த நாட்கள்
                </h1>
                <div className="relative h-[300px] md:h-[450px] w-full mb-10 rounded-3xl overflow-hidden shadow-2xl">
                    <OptimizedImage
                        ...
                        alt="2026 மார்ச் முகூர்த்த நாட்கள்"
                        fill
            ...
            <div className="prose prose-lg max-w-none text-gray-800 space-y-8 leading-relaxed">
                <p className="text-xl">
                    2026 ஆம் ஆண்டு மார்ச் மாதத்தில் திருமணம் செய்யத் திட்டமிட்டுள்ளீர்களா? 
                    இந்த மாதத்தில் மொத்தம் 5 சுப முகூர்த்த நாட்கள் உள்ளன. 
            ...
            <div className="my-12 p-8 bg-orange-50/50 border border-orange-100 rounded-3xl text-gray-800 space-y-4">
                <h3 className="text-xl font-bold text-gray-900">March 2026 முகூர்த்த நாட்களின் சிறப்புகள்:</h3>
                <p className="leading-relaxed">பங்குனி மாதம் உத்திர நட்சத்திரத்தன்று இறைவனின் திருமணங்கள் பல நடைபெற்றதாக புராணங்கள் கூறுகின்றன. இதனால் பங்குனி உத்திரம் திருமணத்திற்கு மிகச் சிறந்த நாளாக போற்றப்படுகிறது. இந்த மாதத்தில் வரும் முகூர்த்த தேதிகள் குடும்ப ஒற்றுமையையும், மகிழ்ச்சியையும் அதிகரிக்கும். திருமணப் பேச்சுவார்த்தை நடத்தவும், நிச்சயதார்த்தம் செய்யவும் பங்குனி மாதம் உகந்தது. குடும்ப ஜோதிடரை ஆலோசித்து தகுந்த நக்ஷத்திர பொருத்தமுடைய தேதியைத் தேர்ந்தெடுக்கவும்.</p>
