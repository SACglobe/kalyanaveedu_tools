...
export const metadata: Metadata = {
    ...
    description: '2026 ஆகஸ்ட் மாதத்திற்கான சிறந்த சுப முகூர்த்த நாட்கள். August 2026 திருமண தேதிகள் மற்றும் நல்ல நேரங்களை இங்கே சரிபார்க்கவும்.',
    alternates: {
    ...
    return (
        <article className="container mx-auto px-4 py-12 max-w-4xl">
            ...
            <Schema 
                ...
                data={{
                    items: [
                        ...
                        { name: 'சுப முகூர்த்த நாட்கள் ஆகஸ்ட் 2026', item: '/blog/subha-muhurtham-2026-august' }
                    ]
                }}
            />
            <header className="mb-10 text-center">
                <h1 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                    2026 ஆகஸ்ட் சுப முகூர்த்த நாட்கள்
                </h1>
                <div className="relative h-[300px] md:h-[450px] w-full mb-10 rounded-3xl overflow-hidden shadow-2xl">
                    <OptimizedImage
                        ...
                        alt="2026 ஆகஸ்ட் முகூர்த்த நாட்கள்"
                        fill
            ...
            <div className="prose prose-lg max-w-none text-gray-800 space-y-8 leading-relaxed">
                <p className="text-xl">
                    2026 ஆம் ஆண்டு ஆகஸ்ட் மாதத்தில் திருமணம் செய்யத் திட்டமிட்டுள்ளீர்களா? 
            ...
            <div className="my-12 p-8 bg-orange-50/50 border border-orange-100 rounded-3xl text-gray-800 space-y-4">
                <h3 className="text-xl font-bold text-gray-900">August 2026 முகூர்த்த நாட்களின் சிறப்புகள்:</h3>
                <p className="leading-relaxed">ஆவணி மாதம் திருமணத்திற்கு மிகவும் உகந்த மாதமாக கருதப்படுகிறது. 'ஆவணி ஞாயிறு' மற்றும் நல்ல நாட்களைக் கொண்டு திருமணங்களை நடத்த மக்கள் பெரிதும் விரும்புவர். ஆவணி மாதத்தில் விவசாய அறுவடைகள் முடிந்து மக்கள் மகிழ்ச்சியாக இருக்கும் காலம் என்பதால், இந்த மாதத்தில் சுப காரியங்கள் செய்வது மங்களகரமாக அமையும். வளர்பிறை மற்றும் அமிர்தயோக தேதிகள் திருமணப் பேச்சுவார்த்தைக்கும், திருமணத்திற்கும் உகந்தவை.</p>
