...
export const metadata: Metadata = {
    title: 'ஜூன் 2026 சுப முகூர்த்த நாட்கள் | June 2026 Muhurtham Dates',
    description: '2026 ஜூன் மாதத்தின் 6 சிறந்த சுப முகூர்த்த நாட்கள் (வளர்பிறை & வார இறுதி நாட்கள் உட்பட). நல்ல நேரம், லக்னம் மற்றும் திருமண தேதிகளின் முழு விபரம்.',
    keywords: [
        'ஜூன் 2026 முகூர்த்த நாட்கள்',
        'சுப முகூர்த்தம்',
        '2026 june tamil calendar',
        'june 2026 muhurtham dates',
        'june 2026 subha muhurtham'
    ],
    alternates: {
    ...
    return (
        <article className="container mx-auto px-4 py-12 max-w-4xl">
            ...
            <Schema 
                ...
                data={{
                    items: [
                        ...
                        { name: 'சுப முகூர்த்த நாட்கள் ஜூன் 2026', item: '/blog/subha-muhurtham-2026-june' }
                    ]
                }}
            />
            <header className="mb-10 text-center">
                <h1 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                    2026 ஜூன் சுப முகூர்த்த நாட்கள்
                </h1>
                <div className="relative h-[300px] md:h-[450px] w-full mb-10 rounded-3xl overflow-hidden shadow-2xl">
                    <OptimizedImage
                        ...
                        alt="2026 ஜூன் முகூர்த்த நாட்கள்"
                        fill
            ...
            <div className="prose prose-lg max-w-none text-gray-800 space-y-8 leading-relaxed">
                <p className="text-xl">
                    2026 ஆம் ஆண்டு ஜூன் மாதத்தில் திருமணம் செய்யத் திட்டமிட்டுள்ளீர்களா? 
                    இந்த மாதத்தில் மொத்தம் 6 சுப முகூர்த்த நாட்கள் உள்ளன. 
            ...
            <div className="my-12 p-8 bg-orange-50/50 border border-orange-100 rounded-3xl text-gray-800 space-y-4">
                <h3 className="text-xl font-bold text-gray-900">June 2026 முகூர்த்த நாட்களின் சிறப்புகள்:</h3>
                <p className="leading-relaxed">ஆனி மாதம் திருமண காரியங்களுக்கு மிகவும் சிறப்பானது. இந்த மாதத்தில் மொத்தம் 6 சிறந்த சுப முகூர்த்த தேதிகள் உள்ளன. இவை அனைத்தும் வளர்பிறை மற்றும் வார இறுதி நாட்களாக அமைந்துள்ளதால், உற்றார் உறவினர்கள் அனைவரும் வந்து வாழ்த்த ஏதுவாக இருக்கும். ஆனி மாதத்தில் செய்யப்படும் திருமணங்கள் தம்பதியினருக்கு நல்ல வம்ச விருத்தியையும், நீண்ட புகழையும் தரும். குடும்பத்தினருடன் ஆலோசித்து உங்கள் ஜாதகத்திற்கு பொருத்தமான தேதியை தேர்ந்தெடுக்கவும்.</p>
                <p className="leading-relaxed text-sm">
                    திருமணத் தேதியைத் தேர்ந்தெடுக்கும் போது மணமகன் மற்றும் மணமகளின் பிறந்த நட்சத்திரம், சந்திராஷ்டமம் மற்றும் தாராபலன் ஆகியவற்றைச் சரிபார்ப்பது முக்கியம். இது குடும்பத்திற்கு நீண்ட ஆயுளையும், மங்களகரமான நல்வாழ்வையும் தரும். எங்களது திருமண பட்ஜெட் பிளானர் போன்ற கருவிகளைப் பயன்படுத்தி உங்களது திருமண செலவுகளையும் இப்போதே திட்டமிடுங்கள்.
                </p>
                <p className="leading-relaxed text-sm mt-4">
                    மேலும், ஆனி, வைகாசி, தை, மற்றும் ஆவணி போன்ற தமிழ் மாதங்களில் சுப முகூர்த்த நாட்கள் அதிகமாக அமைவதால், மண்டப முன்பதிவு மற்றும் சமையல் ஒப்பந்தங்களை (Catering Orders) முகூர்த்த நாளுக்கு குறைந்தது 6 மாதங்களுக்கு முன்பே செய்வது அவசியமாகும். கடைசி நேரத்தில் திட்டமிடும் போது கூடுதல் செலவுகள் மற்றும் மன அழுத்தம் ஏற்பட வாய்ப்புள்ளது. எனவே, திருமண வேலைகள் பட்டியலைத் தயாரித்து பணிகளை முன்கூட்டியே திட்டமிடுங்கள்.
                </p>
                <p className="leading-relaxed text-sm mt-4">
                    இத்துடன், மணமகன் மற்றும் மணமகள் வீட்டார் இருவரும் இணைந்து சுமுகமான பட்ஜெட் திட்டமிடல் (Budget Calculator) மூலம் வரவு செலவுகளைப் பகிர்ந்து கொள்ளலாம். இது தேவையற்ற பண விரயத்தைத் தடுத்து, திருமணத்தை அமைதியான முறையில் நடத்தி முடிக்க உதவும். மேலும் நல்ல நேரம், கௌரி பஞ்சாங்கம் போன்ற பாரம்பரிய கால நேரங்களை ஜோதிடரிடம் சரிபார்ப்பதும் நல்லது.
                </p>
            </div>
