...
export const metadata: Metadata = {
    ...
    description: '2026 ஜனவரி மாதத்திற்கான சிறந்த சுப முகூர்த்த நாட்கள். January 2026 திருமண தேதிகள் மற்றும் நல்ல நேரங்களை இங்கே சரிபார்க்கவும்.',
    alternates: {
    ...
    return (
        <article className="container mx-auto px-4 py-12 max-w-4xl">
            ...
            <Schema 
                ...
                data={{
                    items: [
                        ...
                        { name: 'சுப முகூர்த்த நாட்கள் ஜனவரி 2026', item: '/blog/subha-muhurtham-2026-january' }
                    ]
                }}
            />
            <header className="mb-10 text-center">
                <h1 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                    2026 ஜனவரி சுப முகூர்த்த நாட்கள்
                </h1>
                <div className="relative h-[300px] md:h-[450px] w-full mb-10 rounded-3xl overflow-hidden shadow-2xl">
                    <OptimizedImage
                        ...
                        alt="2026 ஜனவரி முகூர்த்த நாட்கள்"
                        fill
            ...
            <div className="prose prose-lg max-w-none text-gray-800 space-y-8 leading-relaxed">
                <p className="text-xl">
                    2026 ஆம் ஆண்டு ஜனவரி மாதத்தில் திருமணம் செய்யத் திட்டமிட்டுள்ளீர்களா? 
                    இந்த மாதத்தில் மொத்தம் 1 சுப முகூர்த்த நாட்கள் உள்ளன. 
            ...
            <div className="my-12 p-8 bg-orange-50/50 border border-orange-100 rounded-3xl text-gray-800 space-y-4">
                <h3 className="text-xl font-bold text-gray-900">January 2026 முகூர்த்த நாட்களின் சிறப்புகள்:</h3>
                <p className="leading-relaxed">தை மாதத்தில் திருமணம் செய்வது மிகவும் சிறப்பானதாக கருதப்படுகிறது. 'தை பிறந்தால் வழி பிறக்கும்' என்ற பழமொழிக்கு ஏற்ப, தை மாதத்தில் பல சுப காரியங்கள் நடத்தப்படுகின்றன. இந்த மாதத்தில் சூரியன் தனுசு ராசியில் இருந்து மகர ராசிக்கு பிரவேசிக்கும் உத்தராயண காலம் தொடங்குகிறது. இது தேவலோகத்தின் பகல் பொழுதாகும், இதனால் சுப காரியங்களுக்கு மிகவும் உகந்த காலமாக கருதப்படுகிறது. தை மாத வளர்பிறை தேதிகளில் திருமணம் செய்வதன் மூலம் தம்பதியரின் வாழ்வில் மகிழ்ச்சியும், செல்வமும் தழைத்தோங்கும் என்பது நம்பிக்கை.</p>
