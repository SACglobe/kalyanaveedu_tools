...
export const metadata: Metadata = {
    ...
    description: '2026 மே மாதத்திற்கான சிறந்த சுப முகூர்த்த நாட்கள். May 2026 திருமண தேதிகள் மற்றும் நல்ல நேரங்களை இங்கே சரிபார்க்கவும்.',
    alternates: {
    ...
    return (
        <article className="container mx-auto px-4 py-12 max-w-4xl">
            ...
            <Schema 
                ...
                data={{
                    items: [
                        ...
                        { name: 'சுப முகூர்த்த நாட்கள் மே 2026', item: '/blog/subha-muhurtham-2026-may' }
                    ]
                }}
            />
            <header className="mb-10 text-center">
                <h1 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                    2026 மே சுப முகூர்த்த நாட்கள்
                </h1>
            ...
            <div className="prose prose-lg max-w-none text-gray-800 space-y-8 leading-relaxed">
                <p className="text-xl">
                    2026 ஆம் ஆண்டு மே மாதத்தில் திருமணம் செய்யத் திட்டமிட்டுள்ளீர்களா? 
            ...
            <div className="my-12 p-8 bg-orange-50/50 border border-orange-100 rounded-3xl text-gray-800 space-y-4">
                <h3 className="text-xl font-bold text-gray-900">May 2026 முகூர்த்த நாட்களின் சிறப்புகள்:</h3>
                <p className="leading-relaxed">வைகாசி மாதம் குரு பகவானின் ஆதிக்கம் நிறைந்த மாதமாகும். இந்த மாதத்தில் பல சுப முகூர்த்த தேதிகள் அமைந்துள்ளன. வைகாசி விசாகம் போன்ற முக்கிய ஆன்மீக தினங்கள் இம்மாதத்தில் வருவதால், திருமணத்திற்கு மிகவும் உகந்ததாக கருதப்படுகிறது. குறிப்பாக வைகாசி வளர்பிறை மற்றும் அமிர்தயோகம் நிறைந்த நாட்களில் திருமணம் செய்வதன் மூலம் தம்பதியரின் வாழ்வில் அனைத்து செல்வங்களும் பெருகும் என்பது ஐதீகம்.</p>
